...
import { deletePaymentRequest, useGetPaymentRequests } from 'src/api/paymentRequest';
...
export default function PaymentRequestListView() {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.admin.paymentRequest.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.admin.paymentRequest.new}
              variant="contained"
